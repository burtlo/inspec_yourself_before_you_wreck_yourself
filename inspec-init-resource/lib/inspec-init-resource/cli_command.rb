...
module InspecPlugins::InitResource
  ...
  class CliCommand < Inspec.plugin(2, :cli_command)
    ...
    def do_something(what = 'nothing')
      ...
      ui.warning('This is a generated plugin with a default implementation.  Edit lib/inspec-init-resource/cli_command.rb to make it do what you want.')
