...
# inspec-init-resource are correct.

# Include our test harness
require_relative '../helper'

# Load the class under test, the CliCommand definition.
require 'inspec-init-resource/cli_command'

# Because InSpec is a Spec-style test suite, we're going to use MiniTest::Spec
# here, for familiar look and feel. However, this isn't InSpec (or RSpec) code.
describe InspecPlugins::InitResource::CliCommand do
  ...
  let(:cli_class) { InspecPlugins::InitResource::CliCommand }
